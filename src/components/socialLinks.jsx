...
export const SocialLinks = ({ animate, color }) => {
    ...
    <div className="flex space-x-6 md:space-x-0  lg:space-x-1 lg:pb-3">
      {social.map((item) => (
        <Link
          ...
          className={clsx(
            animate && iconColor,
            item.name == 'YouTube' && '!text-red-500',
      ...
      >
        <img
          className="h-7 w-7 flex-none fill-sky-500 stroke-sky-500 text-sky-500 md:h-8  md:w-8 "
